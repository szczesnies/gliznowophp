...
<head>
  ...
  <link rel="stylesheet" href="/style.css?v=20260516-21">
</head>
<body style="background:#0f0f0f;color:#fafafa;margin:0">
  ...
  <main id="appView" class="wrap hidden">
    <div class="banner"><img src="/banner.png?v=20260516-21" alt="Maszyny Gliznowo"></div>
  ...
  <script>
    ...
    function openDetails(id) {
      ...
      $('modal').innerHTML = `<div class="product-modal"><div class="product-wrap">
        <div class="product-banner"><img src="/banner.png?v=20260516-21" alt="Maszyny Gliznowo"></div>
